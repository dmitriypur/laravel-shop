                    ...
                    <table class="table text-center">
                        ...
                        <?php foreach($_SESSION['cart'] as $product_id => $product):?>
                            <tr class="cart-product-item">
                                <td class="product-remove">
                                    <a href="#" data-id="<?=$product_id;?>" data-cart="cart" class="remove"><i class="fa fa-trash-o"></i></a>
                                </td>
                                <td class="product-thumb">
                                    <a href="product/<?=$product['alias'];?>">
                                        <img src="<?= PATH ?>/<?=$product['img'];?>" width="90" height="110" alt="<?=$product['title'];?>">
                                    </a>
                                </td>
                                <td class="product-name">
                                    <h4 class="title"><a href="product/<?=$product['alias'];?>"><?=upper($product['title']);?></a></h4>
                                </td>
                                <td class="product-price">
                                    <span class="price" data-price="<?=$product['price'];?>"><?=$product['price'];?>р.</span>
                                </td>
                                <td class="product-quantity">
                                    <div class="pro-qty">
                                        <input type="text" class="quantity" title="Quantity" value="<?=$product['qty'];?>">
                                    </div>
                                </td>
                        ...
                        <tr class="actions">
                            ...
                            <td class="border-0" colspan="1" style="text-align: right;">
                                ...
                                <p>Сумма: <span id="final__sum"><?=$_SESSION['cart.sum']; ?></span></p>
                            </td>
                        </tr>
                        <tr class="actions">
                            <td class="border-0" colspan="6">
                                <a href="<?= $_SERVER['HTTP_REFERER'] ?? PATH; ?>" class="btn-theme btn-flat">Продолжить покупки</a>
                                <a href="<?= PATH ?>/cart/delete" class="btn-theme clear-cart-page" data-cart="page-cart">Очистить корзину</a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
